...
const loginAuth = async (payload: LoginCredential): Promise<LoginResponse> => {
...
const refreshTokenAuth = async (token: string): Promise<RefreshToken> => {
...
const changePasswordAuth = async (
  ...
  isUserExist.needChangePassword = false;
